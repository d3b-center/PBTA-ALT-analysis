...
meta <- read_tsv("~/Documents/GitHub/Cole-telomere-analysis/analyses/add-histologies/output/ALT PBTA Sept 2021 (not including plate 3)-updated-hist-alt.tsv",
         guess_max = 1000)
...
plot_metric(opt_cut)
#save as PDF
pdf("~/Documents/GitHub/Cole-telomere-analysis/analyses/cutpoint-analysis/plots/all-pbta-by-subgroup.pdf", height = 4, width = 6, onefile=FALSE)
plot_metric(opt_cut)
invisible(dev.off())
```
...
```{r}
plot(cp)
pdf("~/Documents/GitHub/Cole-telomere-analysis/analyses/cutpoint-analysis/plots/all-pbta.pdf", height = 4, width = 8, onefile=FALSE)
plot(cp)
invisible(dev.off())
```
#hgat alone - cutpoint
...
```{r}
plot(cp)
pdf("~/Documents/GitHub/Cole-telomere-analysis/analyses/cutpoint-analysis/plots/hgat.pdf", height = 4, width = 8, onefile=FALSE)
plot(cp)
invisible(dev.off())
```
...
```{r}
plot(cp)
pdf("~/Documents/GitHub/Cole-telomere-analysis/analyses/cutpoint-analysis/plots/non-hgat.pdf", height = 4, width = 8, onefile=FALSE)
plot(cp)
invisible(dev.off())
```