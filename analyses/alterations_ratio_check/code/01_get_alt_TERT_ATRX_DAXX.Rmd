...
cohort_plot_labels %>%
  ...
  full_join(merge_TERT,by=c("Kids_First_Biospecimen_ID"="Tumor_Sample_Barcode")) %>%
  full_join(merge_ATRX,by=c("Kids_First_Biospecimen_ID"="Tumor_Sample_Barcode")) %>%
  full_join(merge_DAXX,by=c("Kids_First_Biospecimen_ID"="Tumor_Sample_Barcode")) %>%
