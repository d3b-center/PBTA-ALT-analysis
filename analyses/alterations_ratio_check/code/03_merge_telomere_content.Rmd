...
merge_dna_alt_DAXX <- read_tsv(file.path(params$merge_dna_alt_DAXX)) %>%
  left_join(cell_line)
merge_dna_alt_DAXX[merge_dna_alt_DAXX  == 0] <- NA

# ATRX alterations
merge_dna_alt_ATRX <- read_tsv(file.path(params$merge_dna_alt_ATRX)) %>%
  left_join(cell_line)
merge_dna_alt_ATRX[merge_dna_alt_ATRX == 0] <- NA

# TERT alterations
merge_dna_alt_TERT <- read_tsv(file.path(params$merge_dna_alt_TERT)) %>%
  left_join(cell_line)
merge_dna_alt_TERT[merge_dna_alt_TERT == 0] <- NA
...
merged_rna_ATRX_DAXX_TERT[merged_rna_ATRX_DAXX_TERT == 0] <- NA
