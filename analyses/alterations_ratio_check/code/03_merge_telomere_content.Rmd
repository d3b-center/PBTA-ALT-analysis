...
plot_per_gene("ATRX",all_alterations_ratio) + ggsave(filename = "../plots/all_alterations_ATRX.png",width = 12)

plot_per_gene("DAXX",all_alterations_ratio) + ggsave(filename = "../plots/all_alterations_DAXX.png",width = 12)

plot_per_gene("TERT",all_alterations_ratio) + ggsave(filename = "../plots/all_alterations_TERT.png",width = 12)

plot_per_gene("ATRX|DAXX",all_alterations_ratio) + ggsave(filename = "../plots/all_alterations_ATRX_or_DAXX.png",width = 12)
