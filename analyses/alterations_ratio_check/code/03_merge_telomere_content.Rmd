...
ggplot(all_alterations_ratio,aes(x=count_alt,y=ratio))+geom_boxplot()+theme(axis.text.x = element_text(angle = 90))+ ggsave(filename = "../output/all_alterations_ATRX_DAXX_TERT.png")
```
