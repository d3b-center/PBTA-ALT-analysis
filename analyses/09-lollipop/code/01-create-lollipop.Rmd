...
```{r annotate dgd maf}
# dgd maf
anno_dgd <- paste(params$python_path, maf_annotator, '-i', file.path(output_dir, "snv-dgd-goi.maf.tsv"), '-o', file.path(output_dir, "dgd_maf-goi-oncokb.tsv"), '-b', oncokb_token, '-q hgvsp_short', '-r GRCh38')
